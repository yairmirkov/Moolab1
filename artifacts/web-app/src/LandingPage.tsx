...
const RADIO_SAMPLE_TEXT = "Welcome to Moolab. The only place building the next generation of financial apex predators.";
  ...
  const togglePlay = () => {
    if (playing) {
      ...
      if ('speechSynthesis' in window) {
        ...
        const utter = new SpeechSynthesisUtterance(RADIO_SAMPLE_TEXT);
        utter.lang = "en-US";
        utter.rate = 0.95;
        utter.pitch = 0.9;
        utter.volume = 0.85;
